document.addEventListener('DOMContentLoaded', function() {
    ...
    listoButtons.forEach(button => {
        ...
        button.addEventListener('click', function() {
            ...
            if (modalTableNumberSpan) modalTableNumberSpan.textContent = currentMesaNumero;
            if (modalPedidoList) {
        ...
        siButton.addEventListener('click', function() {
            ...
            if (currentPedidoId) {
                ...
                .then(data => {
                    ...
                    if (confirmationModal) confirmationModal.style.display = 'none'; // Ocultar modal de confirmación
