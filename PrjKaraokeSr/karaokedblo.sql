...
INSERT INTO `categorias_producto` (`id_categoria_producto`, `nombre`, `descripcion`, `estado`, `fecha_creacion`, `fecha_actualizacion`) VALUES
	...
	(13, 'ingredientes', NULL, 1, '2025-06-18 19:00:56', '2025-06-18 19:00:56'),
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Comprobantes de pago emitidos';

-- Dumping data for table karaokedb.comprobantes: ~12 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Detalla los métodos de pago para ítems específicos o cantidades de ítems dentro de un comprobante.';

-- Dumping data for table karaokedb.pagos_pedido_detalle: ~16 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Detalle de los productos por pedido y su estado de preparación';
...
INSERT INTO `productos` (`id_producto`, `id_categoria_producto`, `area_destino`, `codigo_interno`, `nombre`, `descripcion`, `precio_unitario`, `stock`, `unidad_medida`, `imagen_url`, `estado`, `fecha_creacion`, `fecha_actualizacion`) VALUES
	...
	(8, 2, 'bar', NULL, 'Negroni', 'Cóctel preparado en barra', 17.00, 44, 'Unidad', '(NULL)', 0, '2025-05-25 07:43:04', '2025-06-15 04:03:39'),
	...
	(116, 8, 'cocina', NULL, 'Harina', NULL, 0.00, 0, NULL, NULL, 1, '2025-06-18 19:00:56', '2025-06-18 19:00:56'),
	...
	(148, 13, 'bar', NULL, 'Jarabe', NULL, 0.00, 0, NULL, NULL, 1, '2025-06-18 19:00:56', '2025-06-18 19:00:56'),
	...
	(153, 13, 'bar', NULL, 'Sal', NULL, 0.00, 0, NULL, NULL, 1, '2025-06-18 19:00:56', '2025-06-18 19:00:56'),
